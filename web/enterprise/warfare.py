...
@bp.route("/killweb/stats")
@login_required
def api_killweb_stats():
    if not kill_web: return jsonify({})
    return jsonify(kill_web.get_stats())

@bp.route("/killweb/approve/<pipeline_id>", methods=["POST"])
@login_required
...
@bp.route("/killweb/abort/<pipeline_id>", methods=["POST"])
@login_required
...
@bp.route("/swarm/auction", methods=["POST"])
@login_required
...
@bp.route("/swarm/dissolve", methods=["POST"])
@login_required
...
@bp.route("/isr/task", methods=["POST"])
@login_required
def api_isr_task():
...
@bp.route("/effects/execute/<chain_id>", methods=["POST"])
@login_required
...
@bp.route("/effects/abort/<chain_id>", methods=["POST"])
@login_required
...
@bp.route("/space/gps-denial", methods=["POST"])
@login_required
...
@bp.route("/mesh/degrade", methods=["POST"])
@login_required
